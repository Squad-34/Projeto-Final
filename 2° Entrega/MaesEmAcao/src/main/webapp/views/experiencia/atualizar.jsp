			...
			<main>
				<section class="section container titulos">
					<form action="./experiencia-atualizar" class="form-control">
						<fieldset>
							<legend class="text-center h3">Atualizar Experiência</legend>
							<div>
								<label for="idExperiencia">Id</label> <input type="text"
									class="form-control" id="idExperiencia" name="idExperiencia" value="${experiencia.idExperiencia}">
							</div>
							<div>
								<label for="nomeEmpresa">Nome Empresa</label> <input
									type="text" class="form-control" id="nomeEmpresa"
									name="nomeEmpresa" value="${experiencia.nomeEmpresa}">
							</div>
							<div>
								<label for="cargo">Cargo</label> <input type="text"
									class="form-control" id="cargo" name="cargo" value="${experiencia.cargo}">
							</div>
							<div>
								<label for="dataInicio">Data Início</label> <input type="date"
									class="form-control" id="dataInicio" name="dataInicio" value="${experiencia.dataInicio}">
							</div>
							<div>
								<label for="dataFinal">Data Final</label> <input type="date"
									class="form-control" id="dataFinal" name="dataFinal" value="${experiencia.dataFinal}">
							</div>
							<div>
								<label for="idCandidato">Id Candidato</label> <input type="text"
									class="form-control" id="idCandidato" name="idCandidato" value="${experiencia.candidato.idCandidato}">
							</div>
							<div>
								<button type="submit" class="btn btn-dark mt-2 botoes">Atualizar</button>

								<a href="./experiencia?id=${experiencia.candidato.idCandidato}" class="btn btn-dark mt-2 botoes">Cancelar</a>
							</div>
						</fieldset>
					</form>
				</section>

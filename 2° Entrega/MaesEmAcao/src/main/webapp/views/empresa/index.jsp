							...
							<tbody>
								...
								<jstl:forEach items="${listaEmpresas}" var="e">
									<tr>
										...
										<td>
											<div class="d-flex">
												<a href="vaga/vaga-deletar?id=${e.empresa.idEmpresa}"
													class="icons-cards" title="Deletar Vagas"
													onclick="return confirm('Deseja deletar a vaga para a empresa ${e.empresa.nome}?')">
													<i class="bi bi-search"></i>
												</a>
											</div>
										</td>

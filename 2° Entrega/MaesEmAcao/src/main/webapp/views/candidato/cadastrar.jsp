		...
		<section class="conteiner-segundario">
			<main>
				<section class="section container titulos">
					<form action="../../candidato-cadastrar" class="form-control">
						<fieldset>
							<legend class="text-center h3">Cadastrar Candidato</legend>
							<div>
							...
							<div>
								...
								<a href="../../candidato" class="btn btn-dark mt-2 botoes">Cancelar</a>
							</div>
						</fieldset>
					</form>
				</section>
